                        ...
                        <span class="v-center">
                            ...
                            <span class="btn btn-circle btn-white btn-lg"><i class="fa fa-graduation-cap"></i></span>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading margin-v-5-3"><a href="#">Cork Institute of Technology </a></h4>
                    ...
                    <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
                        ...
                        <span class="v-center">
                            ...
                            <span class="btn btn-circle btn-primary btn-lg"><i class="fa fa-graduation-cap"></i></span>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading margin-v-5-3"><a href="#">Best practices from hospitality practitioners.</a></h4>
                                    <p class="small margin-none">
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                    ...
                    <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
                        ...
                        <span class="v-center">
                            ...
                            <span class="btn btn-circle btn-red-500 btn-lg"><i class="fa fa-graduation-cap"></i></span>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading margin-v-5-3"><a href="#">Accreditation and Recognition - Hibernia College</a></h4>
                                    <p class="small margin-none">
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                    ...
                    <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
                        ...
                        <span class="v-center">
                            ...
                            <span class="btn btn-circle btn-orange-500 btn-lg"><i class="fa fa-graduation-cap"></i></span>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading margin-v-5-3"><a href="#">Compliance and Endorsements</a></h4>
                                    <p class="small margin-none">
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                    ...
                    <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
                        ...
                        <span class="v-center">
                            ...
                            <span class="btn btn-circle btn-purple-500 btn-lg"><i class="fa fa-graduation-cap"></i></span>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading margin-v-5-3"><a href="#">FLOW Hospitality Training</a></h4>
                                    <p class="small margin-none">
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                    ...
                    <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
                        ...
                        <span class="v-center">
                            ...
                            <span class="btn btn-circle btn-white btn-lg"><i class="fa fa-graduation-cap"></i></span>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading margin-v-5-3"><a href="#">Irish Hospitality Professional</a></h4>
                                    <p class="small margin-none">
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
                                        <span class="fa fa-fw fa-star text-yellow-800"></span>
