                    ...
                    <ul class="nav navbar-nav navbar-nav-bordered navbar-right">
                            ...
                            <ul class="dropdown-menu" role="notification">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-left">
                                        <img src="<?php echo base_url(); ?>images/people/50/guy-2.jpg" alt="people" class="img-circle" width="30">
                                    </div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-left">
                                        <img src="<?php echo base_url(); ?>images/people/50/guy-6.jpg" alt="people" class="img-circle" width="30">
                                    </div>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="">
                                            <img class="width-30 img-circle" src="<?php echo base_url(); ?>images/people/50/woman-6.jpg" alt="people">
                                        </a>
                                        <a href="">
                                            <img class="width-30 img-circle" src="<?php echo base_url(); ?>images/people/50/woman-3.jpg" alt="people">
                                        </a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle user" data-toggle="dropdown">
                                <img src="<?php echo base_url(); ?>images/people/110/guy-5.jpg" alt="Bill" class="img-circle" width="40" /> Bill <span class="caret"></span>
                            </a>
