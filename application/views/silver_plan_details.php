                ...
                <div class="col-md-9">
                    ...
                    <div class="tabbable paper-shadow relative" data-z="0.5">
                       ...
                       <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="<?php echo base_url() ;?>online_training/silver_plan"></i> <span class="hidden-sm hidden-xs">Silver Plan Features</span></a></li>
                    ...
                    <h1 class="page-section-heading">Silver Plan information here</h1>
