                            ...
                            <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
                                <div class="panel-body">
                                    <div class="media media-clearfix-xs">
                                        ...
                                        <br>
                                            <h4 class="media-heading margin-v-5-3"><a href="website-course.html">Tom Delaney BSc Eng Tech MIEI</a></h4>
                ...
                <div class="col-md-3">
                    <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
                        <div class="panel-heading panel-collapse-trigger">
                            <h4 class="panel-title"><a href="<?php echo base_url();?>online_training/sign_up">Sign Up</a></h4>
                        </div>
                        <div class="panel-body list-group">
                            <ul class="list-group list-group-menu">
                                <li class="list-group-item"><a href="<?php echo base_url();?>map/location_map">Company Offices</a></li>
                                <li class="list-group-item"><a href="<?php echo base_url();?>online_training/how_is_training_delivered">How is training delivered</a></li>
                                <li class="list-group-item"><a href="<?php echo base_url();?>online_training/courses">Available courses</a></li>
                                <li class="list-group-item"><a href="<?php echo base_url();?>online_training/meet_the_tutors">Who are the Tutors</a></li>
                                <li class="list-group-item"><a href="<?php echo base_url();?>online_training/meet_the_team"><span>Meet The Team</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <h4>Featured</h4>
