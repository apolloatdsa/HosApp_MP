                    ...
                    <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                        ...
                        <li class="dropdown user">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo base_url(); ?>/breezecatcher_api/test_page"><i class="fa fa-sign-out"></i> Logout</a></li>
                            </ul>
                        </li>
                        <!-- // END user -->
                    </ul>
                    <a href="<?php echo base_url(); ?>breezecatcher_api/test_page" class="navbar-btn btn btn-primary">Log In</a>
                </div>
            </div>
            <!-- /.navbar-collapse -->
        </div>
