                ...
                <div class="col-md-9">
                    ...
                    <div class="tabbable paper-shadow relative" data-z="0.5">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" ><a href="<?php echo base_url() ;?>online_training/bronze_plan"></i> <span class="hidden-sm hidden-xs">Bronze Plan Features</span></a></li>
                    ...
                    <h1 class="page-section-heading">Bronze Plan information here</h1>
