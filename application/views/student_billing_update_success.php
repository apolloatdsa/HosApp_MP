                ...
                <div class="col-md-9">
                    ...
                    <div class="tabbable paper-shadow relative" data-z="0.5">
                        ...
                        <ul class="nav nav-tabs">
                           ...
                           <li class="active"><a href="<?php  echo base_url(); ?>student/student_card_upsate_success"><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Billing Details Update Success</span></a></li>  
                             ...
                             <!--   <form action="#" class="form-horizontal"> -->
                                ...
                                <div class="list-group margin-none">
                                    ...
                                    <div class="media-left">
                                        ...
                                        <h3 class="">Thank you your payment details have been updated</h3>
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('student_card_update_controller/index');  ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br /><input class="form-control"  id="student_card_number" type="number" name="student_card_number" maxlength="30" value="<?php echo	$student_card_number; ?>"  />
						...
						<br /><?php echo form_dropdown('year',  $options, set_value('year'), 'class="btn dropdown-toggle form-control selectpicker btn-white"')?>
                                            ...
                                            <div class="form-group">
                                               <label for="student_ccv_number">CCV <span class="required">*</span></label>
                                                ...
                                                <br /><input class="form-control"  id="student_ccv_number" type="text" name="student_ccv_number" maxlength="3" value="<?php echo	$student_ccv_number; ?>"  />
                                            </div>
