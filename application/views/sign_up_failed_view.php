        ...
        <div class="container parallax-layer" data-opacity="true">
            <div class="media media-grid v-middle">
                ...
                <div class="media-body">
                    <h3 class="text-display-2 text-white margin-none">Failed to submit </h3>
                    <p class="text-white text-subhead">Please try again.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="panel margin-none panel-default paper-shadow max-width-400 h-center" data-z="0.5">
                ...
                <div class="panel-body " style="min-height: 300px;" >
                 ...
                 <h1>Failed </h1>
                    <h4>
                    If you require assistance plaese call Free Phone
