...
class Ion_auth_model extends CI_Model
{
	...
	**/
	...
	public function user_level($id){
		...
		$query_level = $this->db->query('SELECT * FROM `users_groups` INNER JOIN groups ON users_groups.group_id = groups.id WHERE user_id ='.$id);

		return $query_level->result();
